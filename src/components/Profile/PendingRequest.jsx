...
const PendingRequest = () => {
  const profilepic = "https://firebasestorage.googleapis.com/v0/b/datawiztech-9a46a.appspot.com/o/profilepic%2Fprofile-circle.png?alt=media&token=ec19eaec-b6f7-472d-8fc4-affdbd330f78"
    ...
    if (error) {
      ...
      if(data.data.data.pending.length === 0){
        return (
            <div className="empty-pending-friends">
              <div className="card-profile-name">
                You have no pending requests
